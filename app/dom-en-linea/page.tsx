          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a href="https://domenlinea.minvu.cl/" target="_blank" rel="noreferrer" aria-label="Ir al portal DOM en Línea (se abre en una nueva pestaña)" className="rounded-full bg-white px-8 py-4 text-center font-black text-[#00174a] shadow-lg">Ir al portal DOM en Línea</a>
